...
class LoginVC: UIViewController {
    ...
    @objc func handleLogin() {
        ...
        AuthService.shared.logUserIn(withEmail: email, password: password) { result, error in
            ...
            tab.authenticateUserAndConfigurUI()
...
//        print("DEBUG: GO SIGN UP")
    ...
    func configureUI() {
        ...
        donHaveAccountButton.anchor(left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, right: view.rightAnchor, paddingLeft: 40, paddingRight: 40)
